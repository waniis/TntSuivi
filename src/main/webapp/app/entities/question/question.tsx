  ...
  return (
    <div>
      <h2 id="question-heading">
        <Translate contentKey="tnTsuiviApp.question.home.title">Questions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="tnTsuiviApp.question.home.createLabel">Create new Question</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {questionList && questionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="tnTsuiviApp.question.choix">Choix</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`tnTsuiviApp.TypeQuestion.${question.typeQuestion}`} />
                  </td>
                  <td>
          ...
          ? question.questionAnswers.map(choix => (  
      ...
      : null}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tnTsuiviApp.question.home.notFound">No Questions found</Translate>
            </div>
          )
        )}
      </div>
