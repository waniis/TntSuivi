...
import { getEntities, reset } from './region.reducer';
  ...
  return (
    <div>
      <h2 id="region-heading">
        <Translate contentKey="tnTsuiviApp.region.home.title">Regions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="tnTsuiviApp.region.home.createLabel">Create new Region</Translate>
        </Link>
      </h2>
          ...
          {regionList && regionList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="tnTsuiviApp.region.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="tnTsuiviApp.region.home.notFound">No Regions found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
