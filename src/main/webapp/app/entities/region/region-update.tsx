  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tnTsuiviApp.region.home.createOrEditLabel">
            <Translate contentKey="tnTsuiviApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : regionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="region-name">
                  <Translate contentKey="tnTsuiviApp.region.name">Name</Translate>
                </Label>
                <AvField
                  id="region-name"
                  type="text"
